...
<div class="form-group chunk-upload-input">
    <label class="col-lg-3 control-label" for="evidence-<?= $attribute ?>"><?= $model->getAttributeLabel($attribute) ?>
    </label>
...
//                            'style' => 'float: left;',
    ...
    <?= Html::activeHiddenInput($model, $attribute, ['class' => $attribute]) ?>
</div>