...
class m151130_171648_RBAC_tables_create extends Migration
{
    /**
...
//        }
        ...
        $this->execute("ALTER TABLE {$authManager->assignmentTable} CHANGE COLUMN user_id user_id INT UNSIGNED NOT NULL;");
        $this->execute("
